...
const unsigned long detectionCooldown = 10000; // Cooldown time in milliseconds to prevent multiple detections
...
void handleNewMessages(int numNewMessages)
{
    ...
    for (int i = 0; i < numNewMessages; i++)
    {
        ...
        if (text == "/start")
        {
            ...
            welcome += "Use los siguientes comandos para interactuar con el ESP32-CAM \n";
            welcome += "/photo : toma una nueva foto\n";
            welcome += "/flash : encender flash LED \n";
