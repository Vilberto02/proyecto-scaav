...
//////////////////////////////////////////////
const char SSID_ESP[] = "Patricio - 2.4G";         //Give EXACT name of your WIFI
const char SSID_KEY[] = "7652990024";             //Add the password of that WIFI connection
const char* host = "sistemaaav.000webhostapp.com";  //Add the host without "www" Example: electronoobs.com
